...
export default function OutgoingChatsScreen() {
  ...
  const EmptyChatList = () => (
    <View style={styles.emptyContainer}>
      <IconFeather
        name="send" // Gelen kutusu boşluğunu temsil eden ikon
        size={70}
        color={colors.text}
        style={styles.emptyIcon}
      />
      <Text style={[styles.emptyTitle, { color: colors.text }]}>
        {t('no_outgoing_chats.title')}
      </Text>
      <Text style={[styles.emptySubtitle, { color: colors.text }]}>
        {t('no_outgoing_chats.desc')}
      </Text>
